...
window.onclick = function(event) {
  if (event.target == modal) {
    ...
    <br>
    <div class="cntinbas">
        Enter Base 1: <input autocomplete="off" class="inp" id="in1" onkeydown="fn1(event)">
        <br>
        <br>
        <br>
        Enter Base 2: <input autocomplete="off" class="inp" id="in2" onkeydown="fn2(event)">
        <br>
        <br>
        <br>
        Enter Height: <input autocomplete="off" class="inp" id="in3" onkeydown="fn(event)">
        <br><br>
        ...
        <script>
            function mathfun(){
                ...
                var w=Number(document.getElementById("in3").value);
                var z= (x+y)*w/2;
