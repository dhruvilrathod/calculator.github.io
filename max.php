...
window.onclick = function(event) {
  if (event.target == modal) {
    ...
    <div class="headinbas">
        MAXIMUN OF GIVEN NUMBERS
    </div>
    <br>
    <br>
    <br>
    <div class="cntinbas">
        Enter Values: <input autocomplete="off" class="inp" id="in1" onkeydown="fn(event)"></input>
        <br>
        <br>
        <button class="ansbtn" value="Add" onclick="add_element_to_array();" >ADD</button>
        
        <div id="Result"></div>
        <br>
        <button class="ansbtn"  onclick="answer()">ANSWER</button>
        <br>
        ...
        <script>
            ...
            function add_element_to_array(){
                array[x] = document.getElementById("in1").value;
                x++;
                document.getElementById("in1").value = "";
                var e = "<br/>";   
                for (var z=1; z<array.length; z++){
                    e += "Value " + z + " = " + array[z] + "<br/>";
            ...
            function answer(){
                ...
                max=document.getElementById("op").value= max;
            }
