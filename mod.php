...
window.onclick = function(event) {
  if (event.target == modal) {
    ...
    <br>
    <div class="cntinbas">
        Enter Dividend: <input autocomplete="off" class="inp" id="in1" onkeydown="fn1(event)">
        <br>
        <br>
        <br>
        Enter Divisior: <input autocomplete="off" class="inp" id="in2" onkeydown="fn(event)">
        <br>
        <br>
        <br>
