...
<body>
    <div class="top">
        ...
        <a href="/calculator/index1.php"><button class="act">HOME</button></a>
        <div class="drp">
        ...
        <button id="myBtn" style="background-color: black; border-width: 0px; color:aliceblue;"><i class="fa fa-sign-out" style="color:aliceblue; background-color: black; font-size:4vw"></i></button>
    </div>
