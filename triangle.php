...
window.onclick = function(event) {
  if (event.target == modal) {
    ...
    <br>
    <div class="cntinbas">
        FOR NORMAL TRIANGLE/ RIGHT-ANGLED TRIANGLE
        <br>
        <br>
        <br>
        Enter Base: <input autocomplete="off" class="inp" id="in1" onkeydown="fn1(event)">
        <br>
        <br>
        <br>
        Enter Height: <input autocomplete="off" class="inp" id="in2" onkeydown="fna(event)">
        <br>
        <br>
        ...
        <br>
        <br>
        Enter Side a: <input autocomplete="off" class="inp" id="in3" onkeydown="fn2(event)">
        <br>
        <br>
        <br>
        Enter Side b: <input autocomplete="off" class="inp" id="in4" onkeydown="fn3(event)">
        <br>
        <br>
        <br>
        Enter Side c: <input autocomplete="off" class="inp" id="in5" onkeydown="fnb(event)">
        <br><br>
        <button class="ansbtn" onclick="mathfun2()">Get Answer</button> 
        <br>
        Answer: <input class="inp" id="op2">
        <script>
            function mathfun(){
            ...
            function mathfun2(){
                ...
                var y=Number(document.getElementById("in4").value);
                var w=Number(document.getElementById("in5").value);
                var p=(x+y+w)/2;
                var q= p*(p-x)*(p-y)*(p-w);
                var z= Math.sqrt(q);
