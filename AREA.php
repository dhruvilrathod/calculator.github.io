...
window.onclick = function(event) {
  if (event.target == modal) {
    ...
    <div class="cntinbas">
        <div class="area">
            <img src="https://www.freepngimg.com/thumb/ring/34290-7-silver-ring-photo.png">
            <a class="link1" href="/calculator/basic/AREA/circle.php">CIRCLE</a>
        </div>
    ...
    <br>
    <div class="area">
        <img src="https://i.ya-webdesign.com/images/white-triangle-png-6.png">
        <a class="link1" href="/calculator/basic/AREA/triangle.php">TRIANGLE</a>
    </div>
    <br>
    <br>
    <br>
    ...
    <br>
    <div class="area">
        <img src="https://www.pngitem.com/pimgs/b/239-2391122_white-square-outline-png.png">
        <a class="link1" href="/calculator/basic/AREA/square.php">SQUARE</a>
    </div>
    <br>
    <br>
    <br>
    ...
    <br>
    <div class="area">
        <img src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAQcAAADACAMAAAA+71YtAAAAA1BMVEX///+nxBvIAAAASElEQVR4nO3BMQEAAADCoPVPbQwfoAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA+BsYAAAF7hZJ0AAAAAElFTkSuQmCC">
        <a class="link1" href="/calculator/basic/AREA/rectangle.php">RECTANGLE</a>
    </div>
    <br>
    <br>
    <br>
    ...
    <br>
    <div class="area">
        <img src="https://webstockreview.net/images/square-clipart-black-and-white-16.png">
        <a class="link1" href="/calculator/basic/AREA/trapezoid.php">TRAPEZIOD</a>
    </div>
    <br>
    <br>
    <br>
    ...
    <br>
    <div class="area">
        <img src="https://www.pngkit.com/png/full/182-1829541_parallelogram-white-parallelogram-png.png">
        <a class="link1" href="/calculator/basic/AREA/parallelogram.php">PARALLELOGRAM</a>
    </div>
    <br>
    <br>
    <br>
