...
window.onclick = function(event) {
  if (event.target == modal) {
    ...
    <div class="cntinbas">
        ...
        <input autocomplete="off" id="in9" class="inpd" onkeydown="fn(event)">
    <br>
    <br>
    <button class="ansbtn" onclick="deter()">Get Answer</button>
    <br>
    ...
    <script>
        function deter(){
            ...
            var z= a*e*i-a*f*h-b*d*i+b*f*g+c*d*h-c*e*g;
