...
window.onclick = function(event) {
  if (event.target == modal) {
    ...
    <div class="headinbas">
        MATRIX AND DETERMINANT CALCULATION
    </div>
    <br>
    <br>
    <br>
    <div class="cntinbas">
        <div>
            <a class="link1" href="/calculator/matrix/determinant.php">Determinant Calculation</a>
        </div>
    <br>
    <br>
    <div>
        <a class="link1" href="/calculator/matrix/2x2matrix.php">2 X 2 Matrix Multiplication</a>
    </div>
    <br>
    <br>
    <div>
        <a class="link1" href="/calculator/matrix/3x3matrix.php">3 X 3 Matrix Multiplication</a>
    </div>
